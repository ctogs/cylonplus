...
# List of CSV files
csv_files = [
    "../data/benchmarking_data_varying_size/benchmarking_data_10000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_50000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_100000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_500000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_1000000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_5000000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_10000000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_50000000.csv",
    "../data/benchmarking_data_varying_size/benchmarking_data_100000000.csv",
]


# List of row counts
row_counts = [10000, 50000, 100000, 500000, 1000000, 5000000, 10000000, 50000000, 100000000]
...
for file, times in execution_times.items():
    ...
    plt.title(f"Pandas Execution Time for {file} with Different CSV Row Counts")
