...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pycylon.net.ucx_communicator",
        "sources": [
            "pycylon/net/ucx_communicator.pyx"
        ]
    },
    "module_name": "pycylon.net.ucx_communicator"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pycylon__net__ucx_communicator
#define __PYX_HAVE_API__pycylon__net__ucx_communicator
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pycylon.net.ucx_communicator' */
#define __Pyx_MODULE_NAME "pycylon.net.ucx_communicator"
extern int __pyx_module_is_main_pycylon__net__ucx_communicator;
int __pyx_module_is_main_pycylon__net__ucx_communicator = 0;

/* Implementation of 'pycylon.net.ucx_communicator' */
...
static int __pyx_pymod_exec_ucx_communicator(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ucx_communicator},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initucx_communicator(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initucx_communicator(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ucx_communicator(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ucx_communicator(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ucx_communicator(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ucx_communicator' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ucx_communicator(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ucx_communicator", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pycylon__net__ucx_communicator) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pycylon.net.ucx_communicator")) {
      if (unlikely(PyDict_SetItemString(modules, "pycylon.net.ucx_communicator", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pycylon/net/ucx_communicator.pyx":2
 * 
 * ##             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pycylon.net.ucx_communicator", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pycylon.net.ucx_communicator");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
