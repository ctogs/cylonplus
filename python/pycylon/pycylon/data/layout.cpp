...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pycylon.data.layout",
        "sources": [
            "pycylon/data/layout.pyx"
        ]
    },
    "module_name": "pycylon.data.layout"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pycylon__data__layout
#define __PYX_HAVE_API__pycylon__data__layout
/* Early includes */
 ...
 */
enum __pyx_t_7pycylon_4data_6layout_Layout {

  /* "pycylon/data/layout.pyx":22
 * 
 *     FIXED_WIDTH = CLayout.clayout.CFIXED_WIDTH
 *     VARIABLE_WIDTH = CLayout.clayout.CVARIABLE_WIDTH             # <<<<<<<<<<<<<<
 */
  __pyx_e_7pycylon_4data_6layout_FIXED_WIDTH = cylon::Layout::FIXED_WIDTH,
  __pyx_e_7pycylon_4data_6layout_VARIABLE_WIDTH = cylon::Layout::VARIABLE_WIDTH
};
...
/* CIntToPy.proto */
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_enum____pyx_t_7pycylon_4data_6layout_Layout(enum __pyx_t_7pycylon_4data_6layout_Layout value);
...
#define __Pyx_MODULE_NAME "pycylon.data.layout"
extern int __pyx_module_is_main_pycylon__data__layout;
int __pyx_module_is_main_pycylon__data__layout = 0;

/* Implementation of 'pycylon.data.layout' */
...
static const char __pyx_k_VARIABLE_WIDTH[] = "VARIABLE_WIDTH";
...
static PyObject *__pyx_n_s_VARIABLE_WIDTH;
...
static PyTypeObject __Pyx_EnumMeta = {
  ...
  "pycylon.data.layout.__Pyx_EnumMeta", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_VARIABLE_WIDTH, __pyx_k_VARIABLE_WIDTH, sizeof(__pyx_k_VARIABLE_WIDTH), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pycylon__data__layout) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pycylon.data.layout")) {
      if (unlikely(PyDict_SetItemString(modules, "pycylon.data.layout", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * if PY_VERSION_HEX >= 0x03040000:             # <<<<<<<<<<<<<<
 * 
 *     Layout = __Pyx_EnumBase('Layout', __Pyx_OrderedDict([
 */
  __pyx_t_2 = ((PY_VERSION_HEX >= 0x03040000) != 0);
  if (__pyx_t_2) {
 ...
 *     ]))
 */
    __pyx_t_1 = __Pyx_PyInt_From_enum____pyx_t_7pycylon_4data_6layout_Layout(__pyx_e_7pycylon_4data_6layout_FIXED_WIDTH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = PyTuple_New(2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_INCREF(__pyx_n_s_FIXED_WIDTH);
    __Pyx_GIVEREF(__pyx_n_s_FIXED_WIDTH);
    PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_n_s_FIXED_WIDTH);
    __Pyx_GIVEREF(__pyx_t_1);
    PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_t_1);
    __pyx_t_1 = 0;
 ...
 *         ('VARIABLE_WIDTH', VARIABLE_WIDTH),             # <<<<<<<<<<<<<<
 *     ]))
 *     __Pyx_globals['FIXED_WIDTH'] = Layout.FIXED_WIDTH
 */
    __pyx_t_1 = __Pyx_PyInt_From_enum____pyx_t_7pycylon_4data_6layout_Layout(__pyx_e_7pycylon_4data_6layout_VARIABLE_WIDTH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = PyTuple_New(2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_INCREF(__pyx_n_s_VARIABLE_WIDTH);
    __Pyx_GIVEREF(__pyx_n_s_VARIABLE_WIDTH);
    PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_n_s_VARIABLE_WIDTH);
    __Pyx_GIVEREF(__pyx_t_1);
    PyTuple_SET_ITEM(__pyx_t_4, 1, __pyx_t_1);
    __pyx_t_1 = 0;
 ...
 */
    ...
    PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_Layout);
    __Pyx_GIVEREF(__pyx_t_4);
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (PyDict_SetItem(__pyx_d, __pyx_n_s_Layout, __pyx_t_4) < 0) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     ]))
 *     __Pyx_globals['FIXED_WIDTH'] = Layout.FIXED_WIDTH             # <<<<<<<<<<<<<<
 *     __Pyx_globals['VARIABLE_WIDTH'] = Layout.VARIABLE_WIDTH
 * else:
 */
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_Layout); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_FIXED_WIDTH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    if (unlikely(PyDict_SetItem(__Pyx_globals, __pyx_n_s_FIXED_WIDTH, __pyx_t_1) < 0)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     __Pyx_globals['VARIABLE_WIDTH'] = Layout.VARIABLE_WIDTH             # <<<<<<<<<<<<<<
 * else:
 *     class Layout(__Pyx_EnumBase):
 */
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_Layout); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_VARIABLE_WIDTH); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (unlikely(__Pyx_globals == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    ...
    if (unlikely(PyDict_SetItem(__Pyx_globals, __pyx_n_s_VARIABLE_WIDTH, __pyx_t_4) < 0)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     class Layout(__Pyx_EnumBase):             # <<<<<<<<<<<<<<
 *         pass
 *     __Pyx_globals['FIXED_WIDTH'] = Layout(FIXED_WIDTH, 'FIXED_WIDTH')
 */
  /*else*/ {
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_Py3MetaclassPrepare(__pyx_t_1, __pyx_t_4, __pyx_n_s_Layout, __pyx_n_s_Layout, (PyObject *) NULL, __pyx_n_s_EnumType, (PyObject *) NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_Py3ClassCreate(__pyx_t_1, __pyx_n_s_Layout, __pyx_t_4, __pyx_t_3, NULL, 0, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (PyDict_SetItem(__pyx_d, __pyx_n_s_Layout, __pyx_t_5) < 0) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *         pass
 *     __Pyx_globals['FIXED_WIDTH'] = Layout(FIXED_WIDTH, 'FIXED_WIDTH')             # <<<<<<<<<<<<<<
 *     __Pyx_globals['VARIABLE_WIDTH'] = Layout(VARIABLE_WIDTH, 'VARIABLE_WIDTH')
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_Layout); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_1 = __Pyx_PyInt_From_enum____pyx_t_7pycylon_4data_6layout_Layout(__pyx_e_7pycylon_4data_6layout_FIXED_WIDTH); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __Pyx_INCREF(__pyx_n_s_FIXED_WIDTH);
    __Pyx_GIVEREF(__pyx_n_s_FIXED_WIDTH);
    PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_n_s_FIXED_WIDTH);
    __pyx_t_1 = 0;
    ...
    if (unlikely(PyDict_SetItem(__Pyx_globals, __pyx_n_s_FIXED_WIDTH, __pyx_t_1) < 0)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
    __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_Layout); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyInt_From_enum____pyx_t_7pycylon_4data_6layout_Layout(__pyx_e_7pycylon_4data_6layout_VARIABLE_WIDTH); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __Pyx_INCREF(__pyx_n_s_VARIABLE_WIDTH);
    __Pyx_GIVEREF(__pyx_n_s_VARIABLE_WIDTH);
    PyTuple_SET_ITEM(__pyx_t_4, 1, __pyx_n_s_VARIABLE_WIDTH);
    __pyx_t_3 = 0;
    ...
    if (unlikely(PyDict_SetItem(__Pyx_globals, __pyx_n_s_VARIABLE_WIDTH, __pyx_t_3) < 0)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  }
  __pyx_L4:;
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pycylon.data.layout", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pycylon.data.layout");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
#pragma GCC diagnostic ignored "-Wconversion"
#endif
    const enum __pyx_t_7pycylon_4data_6layout_Layout neg_one = (enum __pyx_t_7pycylon_4data_6layout_Layout) -1, const_zero = (enum __pyx_t_7pycylon_4data_6layout_Layout) 0;
#ifdef __Pyx_HAS_GCC_DIAGNOSTIC
#pragma GCC diagnostic pop
#endif
    const int is_unsigned = neg_one > const_zero;
    if (is_unsigned) {
        if (sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout) < sizeof(long)) {
            return PyInt_FromLong((long) value);
        } else if (sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout) <= sizeof(unsigned long)) {
            return PyLong_FromUnsignedLong((unsigned long) value);
#ifdef HAVE_LONG_LONG
        } else if (sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout) <= sizeof(unsigned PY_LONG_LONG)) {
            return PyLong_FromUnsignedLongLong((unsigned PY_LONG_LONG) value);
#endif
        }
    } else {
        if (sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout) <= sizeof(long)) {
            return PyInt_FromLong((long) value);
#ifdef HAVE_LONG_LONG
        } else if (sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout) <= sizeof(PY_LONG_LONG)) {
            return PyLong_FromLongLong((PY_LONG_LONG) value);
#endif
        }
    }
    {
        int one = 1; int little = (int)*(unsigned char *)&one;
        unsigned char *bytes = (unsigned char *)&value;
        return _PyLong_FromByteArray(bytes, sizeof(enum __pyx_t_7pycylon_4data_6layout_Layout),
                                     little, !is_unsigned);
    }
}
